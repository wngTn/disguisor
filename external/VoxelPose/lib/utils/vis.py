...
# Might need to change this path for different datasets. It's used to visualize the synthetic joints
VISUALIZATION_INPUT_PATH = '../../data/Hard'
...
def save_batch_image_with_joints_multi(batch_images,
    ...
    for cam_num in range(len(batch_images)):
        ...
        ndarr = cv2.imread(os.path.join(VISUALIZATION_INPUT_PATH, f'cn0{cam_num + 1}/0000004000_color.jpg'))
